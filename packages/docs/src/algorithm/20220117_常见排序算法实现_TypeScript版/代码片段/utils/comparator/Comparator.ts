// It just assumes that "a" and "b" are numbers.
export type TypeCompareParam = number | string;

export type TypeCompareFun = (a: TypeCompareParam, b: TypeCompareParam) => number;
