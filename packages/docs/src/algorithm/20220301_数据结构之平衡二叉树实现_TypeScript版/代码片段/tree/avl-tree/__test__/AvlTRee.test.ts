...
describe('avlTree', () => {
   ...
   *    4      11                        4      11                   4      11
   *   / \       \          =>          / \       \         =>      / \       \
   *  1   7       12                   1   7       12              1   6       12
   *     /                                /                           / \
   *    6                                6                           5   7
   *                                    /
   *                                   5
   */
  it('should do complex left-left rotation of root node is parent right child', () => {
    const tree = new AvlTree();
    ...
    expect(tree.toString()).toBe('1,4,6,7,10,11,12');

    tree.insert(5);
    expect(tree.toString()).toBe('1,4,5,6,7,10,11,12');
  });
  ...
  it('should do left right rotation and keeping left right node safe 1', () => {
    const tree = new AvlTree();
  ...
  it('should do left right rotation and keeping left right node safe 2', () => {
    const tree = new AvlTree();
   ...
   *          7   9
   */
  it('should keep balance after removal of parent node balance', () => {
    const tree = new AvlTree();
   ...
   *          7   9
   */
  it('should keep balance after removal of parent node not balance', () => {
    const tree = new AvlTree();
    ...
    expect(tree.toString()).toBe('1,2,3,4,6,7,8,9');
    expect(tree.root.value).toBe(4);
    expect(tree.root.height).toBe(3);
